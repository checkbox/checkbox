...
DATA_FILES = [
    ("/usr/lib/plainbox-providers-1/certification-server-soc/whitelists",
        glob("provider_whitelists/*")),
    ("/usr/share/plainbox-providers-1", ["certification-server-soc.provider"])
]
