...
setup(
    name='2015.com.canonical.certification:qml-tests',
    version="1.0",
    description=N_("The 2015.com.canonical.certification:qml-tests provider"),
    gettext_domain="2015_com_canonical_certification_qml-tests",
)
