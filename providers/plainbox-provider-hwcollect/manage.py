...
setup(
    name='2013.com.canonical.certification:hwcollect',
    version="1.0",
    description=N_("Plainbox provide for the Canonical hardware collection tool"),
    gettext_domain="plainbox-provider-hwcollect"
)
