...
setup(
    name='plainbox-provider-restart-demo',
    namespace='2015.pl.zygoon.restart-demo',
    version="1.0",
    description=N_("Demonstration provider for showcasing application restart"),
    gettext_domain="plainbox-provider-restart-demo",
)
